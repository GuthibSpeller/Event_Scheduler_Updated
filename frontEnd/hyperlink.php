<?php 
    include "../backEnd/hyperlinkController.php";
...
<body>
    ...
    <div id="eventAddModal" class="modal" style="display: none">
        <form class="modal-form" action="../backEnd/hyperlinkController.php?method_finder=create" method="post" onsubmit="return validateEvent();">
    ...
    <div id="eventEditModal" class="modal" style="display: flex">
        <form class="modal-form" action="../backEnd/hyperlinkController.php?method_finder=update" method="post">
...
<nav class="dashboard-navbar">
    ...
    <div class="dashboard-navbar-logo-side">
        ...
        <span class="dashboard-navbar-title">Organization: HYPERLINK</span>
    </div>
    ...
    <table id="eventsTable" class="dashboard-table">
        ...
        <tbody class="table-body">
            ...
            <tr class="table-row">
                ...
                <td class="table-cell">
                     <form id="editForm" action="../backEnd/hyperlinkController.php?method_finder=edit" method="post" class="edit-event-form">
                        ...
                        <form action="../backEnd/hyperlinkController.php?method_finder=delete" method="get" style="display: inline;" class="delete-event-form">
