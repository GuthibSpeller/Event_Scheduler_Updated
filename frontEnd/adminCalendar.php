...
<body>
    ...
    <div class="admin-button">
        <!--
        <button onclick="window.location.href='AdminDashboard.php'" class="admin-btn">Back<i class="fa-solid fa-arrow-right-from-bracket"></i></button>
        -->
        <button class="admin-btn" onclick="window.location.href='<?= $homePage ?>'">Home</button>
    </div>
</nav>
