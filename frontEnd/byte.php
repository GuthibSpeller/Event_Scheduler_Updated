...
<head>
    ...
    <link rel="stylesheet" href="styling/AdminAllOrg.css">
...
<body>
    ...
    <div id="eventAddModal" class="modal" style="display: none">
        <form class="modal-form" action="../backEnd/byteController.php?method_finder=create" method="post" onsubmit="return validateEvent();">
    ...
    <div id="eventEditModal" class="modal" style="display: flex">
        <form class="modal-form" action="../backEnd/byteController.php?method_finder=update" method="post">
            ...
            <div>
                ...
                <select name="event_status" class="modal-input" required >
...
<nav class="dashboard-navbar">
    ...
    <div class="dashboard-navbar-logo-side">
        ...
        <span class="dashboard-navbar-title">Organization: BYTE</span>
    </div>
    ...
    <table id="eventsTable" class="dashboard-table">
        ...
        <tbody class="table-body">
            ...
            <tr class="table-row">
                ...
                <td class="table-cell">
                        <form id="editForm" action="../backEnd/byteController.php?method_finder=edit" method="post" class="edit-event-form">
                        ...
                        <form action="../backEnd/byteController.php?method_finder=delete" method="get" style="display: inline;" class="delete-event-form">
                            <input type="hidden" name="method_finder" value="delete">
                            <input type="hidden" name="id" value="<?= htmlspecialchars($event['id'])?>">
                            <button type="submit" class="btnDelete" onclick="return confirm('Are you sure you want to delete')"><div class="fa-solid fa-delete-left"></div></button>
                         </form>
                </td>
            </tr>
            <?php endforeach; ?>
